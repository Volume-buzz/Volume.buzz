...
export default function SpotifyPage() {
  ...
  const checkSpotifyConnection = async () => {
    ...
    const minLoadingTime = 1500; // Minimum 1.5 seconds to show the beautiful loading state
    ...
    try {
      ...
      // Ensure minimum loading time to show the beautiful loading state
        ...
        >
          <div className="flex flex-col items-center text-center space-y-8">
            ...
            <div className="space-y-2">
              ...
              <p className="text-white/60 text-sm">Checking connection...</p>
            </div>
