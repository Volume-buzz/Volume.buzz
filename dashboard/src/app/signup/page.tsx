...
export default function SignUp() {
  ...
  return (
    <div className="relative min-h-screen w-screen overflow-hidden bg-black flex items-center justify-center p-4">
      ...
      {/* Gradient Overlays */}
      <div className="absolute inset-0 bg-gradient-to-tl from-black/70 via-black/50 to-black/70 pointer-events-none" />
        ...
        <div className="rounded-3xl border border-white/10 bg-white/5 backdrop-blur-xl p-8 shadow-2xl">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-white/60 font-light text-sm">
              Join thousands of users earning tokens by listening to music
            </p>
          </div>
          ...
          <div className="space-y-4 mb-8">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="text-white font-light mb-1">Join our Discord server</h3>
                <p className="text-white/60 text-sm font-light">
                  Click the Discord button below to join our community
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="text-white font-light mb-1">Connect your Spotify</h3>
                <p className="text-white/60 text-sm font-light">
                  Use the <code className="bg-white/10 px-2 py-1 rounded text-green-300">/login</code> command to link your account
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="text-white font-light mb-1">Start earning</h3>
                <p className="text-white/60 text-sm font-light">
                  Participate in music raids and earn Solana tokens automatically
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-3">
            ...
            <button
              className={cn(
                "w-full rounded-2xl border border-[#5865F2]/20 bg-[#5865F2]/10 px-6 py-4 text-center backdrop-blur-sm transition-all duration-300",
                "hover:bg-[#5865F2]/20 hover:border-[#5865F2]/30",
                "focus:outline-none focus:ring-2 focus:ring-[#5865F2]/30",
            ...
            >
              ...
              <span className="text-[#5865F2] font-light">Join Discord Server</span>
            </button>
            ...
            >
              ...
              <span className="text-green-300 font-light">Connect Spotify Account</span>
            </button>
          </div>

          {/* Benefits */}
          <div className="mt-8 p-4 rounded-xl border border-white/5 bg-white/[0.02]">
            <h4 className="text-white/80 font-light mb-3 text-sm">What you&apos;ll get:</h4>
            <ul className="space-y-2 text-xs text-white/60 font-light">
              <li className="flex items-center gap-2">
                <span className="h-1 w-1 rounded-full bg-green-400/60" />
                Real Solana cryptocurrency rewards
              </li>
              <li className="flex items-center gap-2">
                <span className="h-1 w-1 rounded-full bg-green-400/60" />
                Access to exclusive music raids
              </li>
              <li className="flex items-center gap-2">
                <span className="h-1 w-1 rounded-full bg-green-400/60" />
                Premium account enhanced features
              </li>
              <li className="flex items-center gap-2">
                <span className="h-1 w-1 rounded-full bg-green-400/60" />
